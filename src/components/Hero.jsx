  ...
  return (
    ...
    >
      <div className="md:w-3/6 w-full">
        <div>
          <p style={{fontSize:"2rem",fontFamily:"cursive",color:"snow"}}>
            The one platform for NFT'S
          </p>
          <h1 className="text-white text-5xl font-bold">
            Purchase and Sell <br /> Digital Arts, <br />
        ...
        <div className="w-3/4 flex justify-between items-center mt-5">
          ...
          <div>
            <p className="text-white font-bold">122k</p>
            <small className="text-gray-300">Artwork</small>
          </div>
          <div>
            <p className="text-white font-bold">75k</p>
      ...
      >
        <img
          src="https://i.pinimg.com/originals/ab/92/90/ab9290e4f21fbd1ffc909b014875ea98.gif"
          alt="NFT Art"
